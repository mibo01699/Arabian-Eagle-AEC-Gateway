...
## 📊 حالة التطبيقات (حسب التوفر)

| الحالة | التطبيقات |
|---|---|
| ✅ **جاهز ويعمل** | BIGISH-YER, AJYAL, GAV, Suppliers-Auction |
| ⏳ **قيد التطوير** | A.E.C Sovereign Fund, Be-well, COBRA, AMAN, Telcom |

**ملاحظة:** التطبيقات غير الجاهزة ستظهر في البوابة كـ `NOT_DEPLOYED` مع رسالة توضيحية.
``
